...
class Voc07Dataset(data.Dataset):
    def __init__(self, 
        img_dir='/media/data1/maleilei/dataset/VOC2007/VOCdevkit/VOC2007/JPEGImages', 
        anno_path='/media/data1/maleilei/dataset/VOC2007/VOCdevkit/VOC2007/ImageSets/Main/trainval.txt', 
        transform=None, 
        labels_path='/media/data1/maleilei/dataset/VOC2007/VOCdevkit/VOC2007/Annotations',
        dup=None,
    ):
        self.dup = dup
        self.img_names  = []
    ...
    def __getitem__(self, index):
        ...
        data = {'image':input, 'name': name, 'target': target}
        if self.return_name:
